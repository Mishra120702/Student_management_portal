...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="main-content pt-16 md:pt-0">
        ...
        <div class="card">
            ...
            <div class="filter-controls" style="margin-bottom: 15px; display: flex; align-items: center; justify-content: space-between;">
                ...
                <div class="export-buttons">
                    <a href="?export=excel&batch=<?= htmlspecialchars($batch_filter) ?>" class="btn-blue">Export Excel</a>
                    <a href="?export=csv&batch=<?= htmlspecialchars($batch_filter) ?>" class="btn-blue">Export CSV</a>
                    <a href="?export=pdf&batch=<?= htmlspecialchars($batch_filter) ?>" class="btn-blue">Export PDF</a>
                </div>
            </div>
